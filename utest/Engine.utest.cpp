...
{
protected:
    Player player1{PLAYER_1, nullptr}; // Pass appropriate Ui pointer in actual implementation
    Player player2{PLAYER_2, nullptr}; // Pass appropriate Ui pointer in actual implementation
