...
void Game::activateEntity(int playerIndex)
{
    ...
    tableEntitiesPlayer1.push_back(playerData[playerIndex].hero->GetName() + " attack " + playerData[1 - playerIndex].hero->GetName() + " with " + std::to_string(playerData[playerIndex].hero->GetAttack()));
    ...
    console->clearConsole();
    console->displayTableEntitiesMenu(playerData[playerIndex].hero->GetName() + "'s table entities", tableEntitiesPlayer1);

    tableEntitiesPlayer2.push_back(playerData[1 - playerIndex].hero->GetName() + " have been attacked by " + playerData[playerIndex].hero->GetName() + " with " + std::to_string(playerData[playerIndex].hero->GetAttack()) + " and minion attack " + std::to_string(minionDamage));
    ...
    console->displayTableEntitiesMenu(playerData[1 - playerIndex].hero->GetName() + "'s table stats", tableEntitiesPlayer2);
